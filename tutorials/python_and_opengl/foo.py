...
surfaces = {
    0: (0, 1, 2), 1: (0, 2, 3), 2: (0, 3, 4), 3: (0, 4, 1),

    4: (2, 5, 3), 5: (2, 6, 5), 6: (5, 6, 7),
    7: (5, 7, 8), 8: (5, 8, 9), 9: (3, 5, 9),

    10: (3, 10, 4), 11: (3, 9, 10), 12: (9, 11, 10),
    13: (10, 11, 12), 14: (10, 12, 13), 15: (4, 10, 13),

    16: (1, 4, 14), 17: (4, 13, 14), 18: (13, 15, 14),
    19: (14, 15, 16), 20: (14, 16, 17), 21: (1, 14, 17),

    22: (2, 18, 6), 23: (1, 18, 2), 24: (1, 17, 18),
    25: (17, 19, 18), 26: (18, 19, 20), 27: (6, 18, 20),

    28: (6, 21, 7), 29: (6, 20, 21), 30: (20, 22, 21), 31: (7, 21, 22),

    32: (9, 23, 11), 33: (8, 23, 9), 34: (11, 23, 24), 35: (8, 24, 23),

    36: (13, 25, 15), 37: (12, 25, 13), 38: (15, 25, 26), 39: (12, 26, 25),

    40: (17, 27, 19), 41: (16, 27, 17), 42: (19, 27, 28), 43: (16, 28, 27),

    44: (8, 29, 24), 45: (7, 29, 8), 46: (7, 22, 29),
    47: (22, 30, 29), 48: (29, 30, 31), 49: (24, 29, 31),

    50: (12, 32, 26), 51: (11, 32, 12), 52: (11, 24, 32),
    53: (24, 31, 32), 54: (26, 32, 33), 55: (31, 33, 32),

    56: (16, 34, 28), 57: (15, 34, 16), 58: (15, 26, 34),
    59: (26, 33, 34), 60: (28, 34, 35), 61: (33, 35, 34),

    62: (28, 35, 36), 63: (30, 36, 35), 64: (22, 36, 30),
    65: (20, 36, 22), 66: (19, 36, 20), 67: (19, 28, 36),

    68: (30, 37, 31), 69: (31, 37, 33), 70: (33, 37, 35), 71: (35, 37, 30)
}


def cmap(x, hue=0.33):
    v = 0.4 + 0.6 * np.clip((1 + x) / 2, 0, 1)
    c = colorsys.hsv_to_rgb(hue, 0.5, v)

    return c
    # return cm.Greens(v)[:3]
    # return cm.rainbow(v)[:3]
